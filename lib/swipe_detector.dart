...
// https://flutteragency.com/how-to-detect-swipes-in-flutter/
class SwipeConfiguration {
  ...
  double horizontalSwipeMinDisplacement = 0.0;
...
class SwipeDetector extends StatelessWidget {
  ...
  final Function(DragUpdateDetails details)? onHorizontalDrag;
  ...
  Widget build(BuildContext context) {
    ...
    DragUpdateDetails updateVerticalDragDetails = DragUpdateDetails(globalPosition: Offset(0,0));

    //Horizontal drag details
    DragStartDetails startHorizontalDragDetails = DragStartDetails();
    DragUpdateDetails updateHorizontalDragDetails = DragUpdateDetails(globalPosition: Offset(0,0));
    ...
    return GestureDetector(
      ...
      onHorizontalDragUpdate: (dragDetails) {
        ...
        onHorizontalDrag?.call(dragDetails);
